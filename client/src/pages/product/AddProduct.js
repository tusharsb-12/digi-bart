                ...
                <div>
                    <div className="">
                        <div className="mt-5 md:mt-0">
                            <PageTitle >
                                <span className='mx-4'>Add Product for listing</span>
                            </PageTitle>
                                    ...
                                    <div className="space-y-6 bg-white px-4 py-5 sm:p-6">
                                        ...
                                        <div>
                                            ...
                                            {/* <p className="mt-2 text-sm text-gray-500">
                                                Product Description: Features, Color, etc
                                            </p> */}
                                        </div>
                                            ...
                                            <div className="col-span-6 sm:col-span-3">
                                                <div className="flex items-start">
                                                    ...
                                                    <div className="ml-3 text-sm">
                                                        ...
                                                        <p className="text-gray-500">Will you ship the product ?</p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div className="col-span-6 sm:col-span-3">
                                                <div className="flex items-start">
                                                    ...
                                                    <div className="ml-3 text-sm">
                                                        ...
                                                        <p className="text-gray-500">Other's can see you product and bid against it.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
